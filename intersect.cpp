...
{
	ray.unitarize();
	Ray PC(ray.origin, origin);	//vector between the origin of the ray and the center of the circle
	double distPH = PC*ray;	//scalar product
	double distCHsq = ray.origin.square_distance_to(origin) - distPH*distPH;
